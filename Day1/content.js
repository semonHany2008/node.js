...
let data = [
  ...
  [
    "Ali",
    [
      "avfda@GamepadHapticActuator.",
      [1236697874, "12369877", [12211, "abdallah"]],
    ],
  ],
];
...
//     data[data.length - 1][data[data.length - 1].length - 1].length - 1
//   ][
//     data[data.length - 1][data[data.length - 1].length - 1][
//       data[data.length - 1][data[data.length - 1].length - 1].length - 1
//     ].length - 1
...
lastElement = lastElement[lastElement.length - 1];
lastElement = lastElement[lastElement.length - 1];
console.log(lastElement); // another solution
